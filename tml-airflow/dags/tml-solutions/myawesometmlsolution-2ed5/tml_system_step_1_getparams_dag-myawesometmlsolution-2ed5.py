...
default_args = {
 ...
 'solutionname': 'myawesometmlsolution-2ed5',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myawesometmlsolution-2ed5", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myawesometmlsolution-2ed5"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
