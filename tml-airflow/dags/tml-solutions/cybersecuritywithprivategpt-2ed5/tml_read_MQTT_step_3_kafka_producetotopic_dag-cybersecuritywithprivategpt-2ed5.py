...
default_args = {
  ...
  'mqtt_broker' : '665fd71733224de6b75294583fcc5dd8.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-2ed5", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-2ed5"], schedule=None,catchup=False)
